...
const GoogleIcon = () => (
  <svg className="h-5 w-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M46.995 24.3c0-1.56-.135-3.12-.405-4.635H24v8.775h12.915c-.54 2.835-2.115 5.265-4.635 6.93v5.67h7.29c4.275-3.96 6.75-9.945 6.75-16.74z" fill="#4285F4"/>
    <path d="M24 48c6.435 0 11.88-2.115 15.84-5.715l-7.29-5.67c-2.115 1.44-4.86 2.3-7.56 2.3-5.805 0-10.71-3.915-12.465-9.18H4.05v5.85C7.965 42.48 15.435 48 24 48z" fill="#34A853"/>
    <path d="M11.535 28.98c-.45-.9-.72-2.25-.72-3.15s.27-2.25.72-3.15v-5.85H4.05C2.835 19.8 2 21.825 2 24.015c0 2.19.84 4.23 2.055 5.85l7.485-5.865z" fill="#FBBC05"/>
    <path d="M24 9.48c3.465 0 6.57 1.17 9.045 3.645l6.435-6.48C35.835 2.88 30.435 0 24 0 15.435 0 7.965 5.52 4.05 13.005l7.485 5.85c1.755-5.265 6.66-9.18 12.465-9.18z" fill="#EA4335"/>
  </svg>
);
    ...
    <div className="flex items-center justify-center min-h-[90vh] bg-slate-100 dark:bg-gray-900 p-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-gray-700">
        ...
        <div className="flex items-center">
            ...
            <span className="mx-4 text-sm font-medium text-slate-400 dark:text-gray-500">OR</span>
            <hr className="flex-grow border-slate-200 dark:border-gray-600" />
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-600 dark:text-gray-400">
          ...
          <Link to="/login" className="text-emerald-600 font-semibold hover:underline dark:text-emerald-500">
            Log in
          </Link>
        </p>
      </div>
